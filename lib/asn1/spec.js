...
Asn1Spec.prototype.decode = function(s, decoder) {
	throw new Error('NODE_RDP_AS1_SPEC_DECODE_NOT_IMPLEMENTED');
};
 ...
 * @param decoder
 */
Asn1Spec.prototype.encode = function(s, decoder) {
	throw new Error('NODE_RDP_AS1_SPEC_ENCODE_NOT_IMPLEMENTED');
};
