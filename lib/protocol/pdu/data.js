	...
	var self = {
        ...
        slowPathInputData : slowPathInputData || new type.Factory(function(s) {
        	...
        	default:
        		...
        		throw new Error('NODE_RDP_PROTOCOL_PDU_DATA_UNKNOWN_SLOWPATH_INPUT');
        	}
        })
	};
	...
	var self = {
		...
		updateData : updateData || new type.Factory(function(s) {
			...
			case UpdateType.UPDATETYPE_BITMAP:
				self.updateData = bitmapUpdateDataPDU(null, { readLength : new type.CallableValue(function() {
	...
	var self = {
		...
		pduMessage : pduMessage || new type.Factory(function(s) {
			...
			default:
				...
				throw new Error('NODE_RDP_PROTOCOL_PDU_DATA_UNKNOWN_PDU_TYPE');
			}
		})
	};
