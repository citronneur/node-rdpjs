...
function rdpInfos(extendedInfoConditional) {
	var self = {
        ...
        domain : new type.BinaryString(new Buffer('siradel\x00', 'ucs2'),{ readLength : new type.CallableValue(function() {
...
function rdpExtendedInfos(opt) {
	var self = {
	    ...
	    clientAddress : new type.BinaryString(null,{ readLength : new type.CallableValue(function() {
	    	return self.cbClientAddress;
	    }) }),
	    cbClientDir : new type.UInt16Le(function() {
        	return self.clientDir.size();
        }),
	    clientDir : new type.BinaryString(null, { readLength : new type.CallableValue(function() {
