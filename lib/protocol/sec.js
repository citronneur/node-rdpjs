...
function rdpInfos() {
	var self = {
        ...
        cbAlternateShell : new type.UInt16Le(lambda:sizeof(self.alternateShell) - 2),
        cbWorkingDir : new type.UInt16Le(lambda:sizeof(self.workingDir) - 2),
        domain : new type.String(readLen = CallableValue(lambda:self.cbDomain.value + 2), unicode = True),
        userName : new type.String(readLen = CallableValue(lambda:self.cbUserName.value + 2), unicode = True),
        password : new type.String(readLen = CallableValue(lambda:self.cbPassword.value + 2), unicode = True),
        alternateShell : new type.String(readLen = CallableValue(lambda:self.cbAlternateShell.value + 2), unicode = True),
        workingDir : new type.String(readLen = CallableValue(lambda:self.cbWorkingDir.value + 2), unicode = True),
        extendedInfo : RDPExtendedInfo(conditional = extendedInfoConditional)
	};
