...
function DomainParameters() {
	return new asn1.univ.Sequence({
		maxChannelIds : new asn1.univ.Integer(),
		maxUserIds : new asn1.univ.Integer(),
		maxTokenIds : new asn1.univ.Integer(),
		numPriorities : new asn1.univ.Integer(),
		minThoughput : new asn1.univ.Integer(),
		maxHeight : new asn1.univ.Integer(),
		maxMCSPDUsize : new asn1.univ.Integer(),
		protocolVersion : new asn1.univ.Integer()
	});
}
...
function Client(transport) {
	MCS.call(this, transport, DOMAIN_MCS_PDU.SEND_DATA_INDICATION, DOMAIN_MCS_PDU.SEND_DATA_REQUEST);
...
Client.prototype.recvConnectResponse = function(s) {
    var userData = new type.Stream(ConnectResponse().decode(s, asn1.ber.decoder).value.userData.value);
