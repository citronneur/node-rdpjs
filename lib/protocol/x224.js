...
Client.prototype.recvConnectionConfirm = function(s) {
	...
	if(message.obj.protocolNeg.obj.type == NegotiationType.TYPE_RDP_NEG_FAILURE) {
		throw new Error('NODE_RDP_PROTOCOL_X224_NEG_FAILURE');
	}
	...
	if([Protocols.PROTOCOL_HYBRID, Protocols.PROTOCOL_HYBRID_EX].indexOf(this.selectedProtocol) !== -1) {
		throw new Error('NODE_RDP_PROTOCOL_X224_NLA_NOT_SUPPORTED');
	}
